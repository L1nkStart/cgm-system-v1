...
export default function CaseDetailPage({ params }: { params: { id: string } }) {
    ...
    const isCoordinadorRegional = userRole === "Coordinador Regional"
            ...
            <Tabs defaultValue="details" className="w-full">
                ...
                <TabsContent value="services">
                    <Card>
                        ...
                        <CardContent>
                            <AttendedServicesTable services={caseData.services || []} />
                        </CardContent>
                    </Card>
                </TabsContent>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="space-y-6">
                                <div>
                                    <h3 className="font-semibold mb-3">Informes Médicos y Resultados</h3>
                                    {caseData.documents && caseData.documents.length > 0 ? (
                                        ...
                                        <p className="text-muted-foreground">No hay informes médicos subidos para este caso.</p>
                                    )}
                                </div>

                                <div>
                                    <h3 className="font-semibold mb-3">Prefacturas</h3>
                                    {caseData.preInvoiceDocuments && caseData.preInvoiceDocuments.length > 0 ? (
                                        <ul className="space-y-2">
                                            {caseData.preInvoiceDocuments.map((doc, index) => (
                                                <li key={index} className="flex items-center gap-2">
                                        ...
                                        <p className="text-muted-foreground">No hay prefacturas subidas para este caso.</p>
                                    )}
                                </div>
                            </div>
                        </CardContent>
